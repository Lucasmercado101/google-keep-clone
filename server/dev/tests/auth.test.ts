...
describe("/auth", () => {
  describe("POST /register", () => {
    ...
    describe("if both 'userName' and 'password' were sent", () => {
      ...
      describe("if valid data was sent", () => {
        ...
        it("should create a single new user in the database", async (done) => {
          app
            .post("/auth/register")
            .send(newUser)
            .expect(200)
            .then(async () => {
              ...
              expect(usersInDb.length).not.toBe(0);
              done();
            });
        });
      });

      describe("if invalid data was sent", () => {
        describe("if 'username' is too long it should return", () => {
          test("400", (done) => {
            app
              .post("/auth/register")
              .send({
        ...
        describe("if 'password' is too long it should return", () => {
          test("400", (done) => {
            app
              .post("/auth/register")
              .send({
